...
const SKILL_CARDS = [
  { id: 'frontend', icon: 'code', tags: ['React', 'Next.js', 'TypeScript', 'Tailwind', 'HTML', 'CSS'] },
  { id: 'uiux', icon: 'design_services', tags: ['Figma'] },
  { id: 'ai', icon: 'smart_toy', tags: ['Claude AI', 'LLMs', 'Prompt Eng.', 'Stitch', 'AI Tools'] },
  { id: 'automation', icon: 'settings_suggest', tags: ['Make', 'Workflows'] },
  { id: 'graphism', icon: 'brush', tags: ['Photoshop', 'Branding'] },
  { id: 'streaming', icon: 'podcasts', tags: ['vMix', 'NDI', 'Broadcast'] },
] as const;
